(function(){
  ...
  const DEMO_TEXTS=[['Antonio','Blanco'].join(' '),['duels','celebrations'].join(', '),['Personal','note','from','Ibai'].join(' '),['Alavés','vs','Rayo'].join(' '),['Season','Archive'].join(' '),['Branding','selection'].join(' '),['Welcome','back'].join(' ')];
