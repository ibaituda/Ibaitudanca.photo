(function(){
  ...
  function injectStyles(){
    ...
    st.textContent=`
      ...
      .overview-mini-list{display:grid;gap:9px}.overview-mini-row{display:grid;grid-template-columns:auto 1fr;gap:9px;align-items:start;border:1px solid var(--line);background:rgba(255,255,255,.025);padding:9px;cursor:pointer}.overview-mini-row strong{display:block;font-size:12px;font-weight:500;color:var(--text)}.overview-mini-row span{display:block;font-size:10.5px;color:var(--muted);margin-top:2px;line-height:1.35}.overview-mini-row b{color:var(--soft);font-weight:500}.task-summary{display:flex;gap:8px;margin:0 0 10px 0}.task-summary span{display:inline-flex;align-items:center;gap:5px;border:1px solid var(--line);background:rgba(255,255,255,.035);padding:6px 8px;font-size:11px;color:var(--soft)}.task-summary i{width:8px;height:8px;border-radius:50%;display:inline-block}.task-summary .red{background:var(--red)}.task-summary .yellow{background:var(--yellow)}.task-summary .green{background:var(--green)}.publication-check-card{display:grid;grid-template-columns:auto 1fr auto;gap:9px;align-items:start;border:1px solid var(--line);background:rgba(255,255,255,.025);padding:8px 9px;cursor:pointer}.publication-check-card .check-dot-real{width:8px;height:8px;border-radius:50%;display:block;margin-top:4px;background:var(--muted)}.publication-check-card.is-red .check-dot-real{background:var(--red)}.publication-check-card.is-yellow .check-dot-real{background:var(--yellow)}.publication-check-card.is-green .check-dot-real{background:var(--green)}.publication-check-card strong{display:block;font-size:12px;font-weight:500;color:var(--text);line-height:1.25}.publication-check-card p{margin:2px 0 0 0;font-size:10.5px;color:var(--muted);line-height:1.35}.publication-check-card .check-source{font-size:9px;color:var(--soft);letter-spacing:.11em;text-transform:uppercase;white-space:nowrap;margin-top:2px}.publication-check-card .check-badge{display:none}.publication-check-empty{border:1px solid var(--line);padding:9px;background:rgba(255,255,255,.025)}.publication-check-empty strong{display:block;color:var(--text);font-size:12px}.publication-check-empty span{display:block;color:var(--muted);font-size:10.5px;margin-top:3px;line-height:1.35}
    `;
  ...
  function renderChecklistHtml(items){
    ...
    return visible.map(item=>`<div class="publication-check-card is-${esc(item.severity)}" data-section-link="${esc(item.target)}"><i class="check-dot-real"></i><div><strong>${esc(item.title)}</strong><p>${esc(item.detail)}</p></div><div class="check-source">${esc(item.source)}</div></div>`).join('');
  }
