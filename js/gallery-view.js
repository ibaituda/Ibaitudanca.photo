(function(){
  ...
  const clean=(v)=>{const s=String(v??'').trim(); return s && !/Antonio Blanco|duels, celebrations|Personal note from Ibai/i.test(s) ? s : '';};
  ...
  const I18N={
    es:{
      'Back to dashboard':'Volver al dashboard','License':'Licencia','Log out':'Cerrar sesión','Ready':'Lista','favourites':'favoritas','No expiry':'Sin caducidad','Client':'Cliente','Event':'Evento','Matchday':'Evento','Date':'Fecha','Access':'Acceso','Private':'Privado','All':'Todo','Favourites':'Favoritas','Selected':'Seleccionadas','Horizontal':'Horizontal','Vertical':'Vertical','Unreviewed':'Sin revisar','selected':'seleccionadas','reviewed':'revisadas','visible':'visibles','Download all':'Descargar todo','Download selected':'Descargar seleccionadas','Download favourites':'Descargar favoritas','Gallery selection':'Selección de galería','Your private images':'Tus imágenes privadas','Open any image to review it in detail. Favourites and selections belong only to this event, so nothing is mixed with other galleries.':'Abre cualquier imagen para revisarla en detalle. Las favoritas y selecciones pertenecen solo a esta galería.','Image usage license':'Licencia de uso de imágenes','Images in this private gallery are licensed only to the client account shown above. Personal use, portfolio archive and agreed social media publication are allowed. Third-party commercial use, agency redistribution, resale or use by representatives requires written permission from Ibai Tudanca.':'Las imágenes de esta galería privada están licenciadas solo para el cliente indicado. Se permite el uso personal, archivo y publicación acordada en redes. El uso comercial por terceros, redistribución, reventa o uso por representantes requiere autorización escrita de Ibai Tudanca.','Gallery summary':'Resumen de galería','Status':'Estado','Files':'Archivos','Sizes':'Formato','Event only':'Solo evento','Private gallery · © 2026':'Galería privada · © 2026','photos selected':'fotos seleccionadas','Add to favourites':'Añadir a favoritas','Clear selection':'Limpiar selección','Favourite':'Favorita','Select':'Seleccionar','Download this image':'Descargar imagen','Show favourites only':'Mostrar solo favoritas','Request edit':'Solicitar retoque','Keyboard: arrows to navigate · F favourite · S select · Esc close':'Teclado: flechas para navegar · F favorita · S seleccionar · Esc cerrar','Photo information':'Información de la foto','148 photos':'0 fotos','Private gallery · Prepared for Antonio Blanco':'Galería privada','Alavés vs':'Galería','Rayo':'privada','Vallecano.':'','A personalised matchday delivery with the strongest actions, reactions and key moments from the event. Review the gallery, mark favourites and download only what you need.':'','Antonio, I have selected this gallery focusing on your duels, celebrations and decisive moments from the match, so you can quickly find the images that work best for social media, personal archive and professional use.':'','Personal note from Ibai · editable from admin panel':'Nota personal de Ibai','24 May 2026':'—'
    },
    en:{
      'Back to dashboard':'Back to dashboard','License':'License','Log out':'Log out','Ready':'Ready','favourites':'favourites','No expiry':'No expiry','Client':'Client','Event':'Event','Matchday':'Event','Date':'Date','Access':'Access','Private':'Private','All':'All','Favourites':'Favourites','Selected':'Selected','Horizontal':'Horizontal','Vertical':'Vertical','Unreviewed':'Unreviewed','selected':'selected','reviewed':'reviewed','visible':'visible','Download all':'Download all','Download selected':'Download selected','Download favourites':'Download favourites','Gallery selection':'Gallery selection','Your private images':'Your private images','Open any image to review it in detail. Favourites and selections belong only to this event, so nothing is mixed with other galleries.':'Open any image to review it in detail. Favourites and selections belong only to this gallery.','Image usage license':'Image usage license','Images in this private gallery are licensed only to the client account shown above. Personal use, portfolio archive and agreed social media publication are allowed. Third-party commercial use, agency redistribution, resale or use by representatives requires written permission from Ibai Tudanca.':'Images in this private gallery are licensed only to the client account shown above. Personal use, portfolio archive and agreed social media publication are allowed. Third-party commercial use, agency redistribution, resale or use by representatives requires written permission from Ibai Tudanca.','Gallery summary':'Gallery summary','Status':'Status','Files':'Files','Sizes':'Format','Event only':'Event only','Private gallery · © 2026':'Private gallery · © 2026','photos selected':'photos selected','Add to favourites':'Add to favourites','Clear selection':'Clear selection','Favourite':'Favourite','Select':'Select','Download this image':'Download this image','Show favourites only':'Show favourites only','Request edit':'Request edit','Keyboard: arrows to navigate · F favourite · S select · Esc close':'Keyboard: arrows to navigate · F favourite · S select · Esc close','Photo information':'Photo information','148 photos':'0 photos','Private gallery · Prepared for Antonio Blanco':'Private gallery','Alavés vs':'Private','Rayo':'gallery','Vallecano.':'','A personalised matchday delivery with the strongest actions, reactions and key moments from the event. Review the gallery, mark favourites and download only what you need.':'','Antonio, I have selected this gallery focusing on your duels, celebrations and decisive moments from the match, so you can quickly find the images that work best for social media, personal archive and professional use.':'','Personal note from Ibai · editable from admin panel':'Personal note from Ibai','24 May 2026':'—'
    }
  };
